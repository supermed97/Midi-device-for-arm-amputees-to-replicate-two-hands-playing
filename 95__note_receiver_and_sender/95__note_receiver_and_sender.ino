 ...
 if (mySerial.available() > 0) {  
  ...
  while(a==144 ){
   ...
   /** chord[n]=temp[0];
    ...
    state=1;
      /**  if (n>2 && state ==0){
       bass=chord[0]-24;  Serial.println("BASS NONTE -> ");  Serial.print(bass);Serial.println("___________________"); 
       blink(8,bass);
   ...
   blink(8);
    ...
    while(a==128){
      ...
      if(b==144){ mySerial.readBytes(residue,2);
                 ...
                 // blink(10); blink(10);blink(10);  Last modifier made
                  }
         }// end of while
      led(9,state);
